...
import (
	"context"
	"encoding/json"
	"go-watermark/internal/util"
	"go-watermark/pkg/watermark/endpoints"
	"net/http"
	"os"
...
func decodeHTTPGetRequest(_ context.Context, r *http.Request) (interface{}, error) {
	...
	if r.ContentLength == 0 {
		_ = logger.Log("Get request with no body")
		return req, nil
	}
...
func decodeHTTPServiceStatusRequest(context.Context, *http.Request) (interface{}, error) {
