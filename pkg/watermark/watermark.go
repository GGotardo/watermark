...
func (w *watermarkService) Get(_ context.Context, _ ...internal.Filter) ([]internal.Document, error) {
...
func (w *watermarkService) Status(_ context.Context, _ string) (internal.Status, error) {
...
func (w *watermarkService) Watermark(_ context.Context, _, _ string) (int, error) {
...
func (w *watermarkService) AddDocument(_ context.Context, _ *internal.Document) (string, error) {
...
func (w *watermarkService) ServiceStatus(_ context.Context) (int, error) {
	_ = logger.Log("ServiceHealth", http.StatusOK)
	return http.StatusOK, nil
}
